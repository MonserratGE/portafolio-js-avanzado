class TrainersService {
	...
	generateData(){
		this.trainers =  [
			{ id: 0, name: "ash ketchum", age: 20, region: 0 },
			{ id: 1, name: "monserrat garcia", age: 18, region: 1},
			{ id: 2, name: "ash ketchum", age: 20, region: 2 },
			{ id: 3, name: "gary oak", age: 20, region: 3 },
			{ id: 4, name: "brock", age: 20, region: 4 },
			{ id: 5, name: "misty", age: 20, region: 5 },
		];
	}
